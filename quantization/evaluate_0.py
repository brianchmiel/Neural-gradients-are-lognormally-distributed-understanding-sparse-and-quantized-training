...
def main_worker(args):
    ...
    if args.pretrained:
        ...
        if 'depth' in model_config:
            model_full_name = str(args.model) + str(model_config['depth'])
        else:
            model_full_name = str(args.model)
        state_dict = load_state_dict_from_url(model_urls[model_full_name], progress=True)
...
if __name__ == '__main__':
    exclude=['pool', 'batch_norm', '__iadd__', 'div', '__add__']
